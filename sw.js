...
(function () {
  ...
  self.addEventListener("fetch", function (event) {
    ...
    if (/meme-channel|go-memes|qr-memes|qr-admin-sheet|qr-class-sheet|qr-friends|qr-school|amal-meme-net|school-party|friends\.html|bedwars\.html|blockbust\.html|print-qr/.test(req.url)) {
