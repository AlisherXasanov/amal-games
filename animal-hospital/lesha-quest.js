(() => {
  ...
  const STAGES = [
    {
      title: "Комната 1 · Кто ты?",
      riddle: "Эта игра только для одного человека. Как тебя зовут в Animal Hospital? (ник или имя)",
      hint: "Тот, кто админ команды. Можно по-русски или по-английски.",
      check: (v) => /^(лёша|леша|lesha|lyosha|amal)$/i.test(v.trim()),
      ok: "✓ Верно. Это правда твоя игра.",
    },
    {
