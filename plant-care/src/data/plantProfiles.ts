...
export const SPECIES_CATALOG: SpeciesOption[] = [
  ...
  },
  {
    ...
    speciesRu: 'Глициния',
    category: 'flowering',
    care: base('flowering', 4, 14, 24, 'direct', 'Удобрение для цветущих кустарников', 'Питательный садовый грунт'),
    keywords: ['wisteria', 'глициния', 'glycine', 'глициния китайская'],
  },
  {
    id: 'jasmine',
    species: 'Jasminum',
    speciesRu: 'Жасмин',
    category: 'flowering',
    care: base('flowering', 4, 14, 18, 'bright', 'Удобрение для цветущих', 'Рыхлый питательный грунт'),
    keywords: ['jasmine', 'жасмин'],
  },
  {
    id: 'lavender',
    species: 'Lavandula',
    speciesRu: 'Лаванда',
    category: 'herb',
    care: base('herb', 7, 21, 18, 'direct', 'Удобрение для пряных трав', 'Лёгкий дренированный грунт', false),
    keywords: ['lavender', 'лаванда'],
  },
  {
    id: 'oleander',
    ...
    speciesRu: 'Олеандр',
    category: 'flowering',
    care: base('flowering', 4, 14, 24, 'direct', 'Удобрение для цветущих кустарников', 'Питательный грунт'),
    keywords: ['oleander', 'олеандр'],
  },
  {
    id: 'bougainvillea',
    species: 'Bougainvillea',
    speciesRu: 'Бугенвиллия',
    category: 'flowering',
    care: base('flowering', 5, 14, 24, 'direct', 'Удобрение для цветущих', 'Лёгкий грунт с дренажем'),
    keywords: ['bougainvillea', 'бугенвиллия', 'бумажный цветок'],
  },
  {
    id: 'grape-ivy',
    species: 'Cissus',
    speciesRu: 'Циссус (комнатный виноград)',
    category: 'tropical',
    care: base('tropical', 5, 21, 18, 'medium', 'Универсальное удобрение для комнатных', 'Универсальный грунт'),
    keywords: ['cissus', 'циссус', 'комнатный виноград'],
  },
  {
    id: 'ivy',
    ...
    category: 'tropical',
    care: base('tropical', 5, 21, 18, 'medium', 'Универсальное удобрение для комнатных', 'Универсальный грунт'),
    keywords: ['ivy', 'hedera', 'плющ'],
  },
  {
    id: 'palm',
    species: 'Chamaedorea',
    speciesRu: 'Пальма хамедорея',
    category: 'tropical',
    care: base('tropical', 6, 21, 24, 'medium', 'Удобрение для пальм', 'Грунт для пальм'),
    keywords: ['palm', 'пальма', 'хамедорея', 'chamaedorea'],
  },
  {
    id: 'dieffenbachia',
    species: 'Dieffenbachia',
    speciesRu: 'Диффенбахия',
    category: 'tropical',
    care: base('tropical', 6, 21, 18, 'medium', 'Удобрение для декоративно-лиственных', 'Универсальный грунт'),
    keywords: ['dieffenbachia', 'диффенбахия'],
  },
  {
    id: 'aglaonema',
    species: 'Aglaonema',
    speciesRu: 'Аглаонема',
    category: 'tropical',
    care: base('tropical', 7, 21, 18, 'low', 'Удобрение для декоративно-лиственных', 'Универсальный грунт'),
    keywords: ['aglaonema', 'аглаонема'],
  },
  {
    id: 'croton',
    ...
    speciesRu: 'Кротон',
    category: 'tropical',
    care: base('tropical', 5, 18, 18, 'bright', 'Удобрение для декоративно-лиственных', 'Питательный грунт'),
    keywords: ['croton', 'кротон', 'кодиеум'],
  },
  {
    id: 'general',
    species: 'Houseplant',
