    ...
    try {
      ...
      s.src = (function () {
        try {
          ...
          if (/\/amal-games\/?$/.test(p) || /\/amal-games\/index\.html$/.test(p)) return "./shared/amal-world-character.js?v=3";
          if (/\/games\/?$/.test(p) || /\/games\/index\.html$/.test(p)) return "./shared/amal-world-character.js?v=3";
          return "../shared/amal-world-character.js?v=3";
        } catch (e) {
          return "../shared/amal-world-character.js?v=3";
        }
      })();
