...
(function (global) {
  ...
  const GAME_PACKS = {
    blockbust: {
      title: "Blockbust",
      subtitle: "Головоломка · кубы · комбо",
      quick: [
        { id: "bb-clear", label: "🧹 Поле", toast: "Поле очищено" },
        { id: "bb-refill", label: "🧩 Фигуры", toast: "Новые фигуры" },
        { id: "bb-score", label: "🏆 +очки", toast: "+10000 очков" },
      ],
      buttons: [
        { id: "heal", label: "💚 ∞ / хил", cls: "primary" },
        { id: "bb-clear", label: "🧹 Очистить поле" },
        { id: "bb-refill", label: "🧩 Новые фигуры" },
        { id: "bb-score", label: "🏆 +10000 очков" },
        { id: "bb-combo", label: "🔥 Комбо ×20" },
        { id: "bb-revive", label: "♻️ Отменить проигрыш" },
    ...
    "x-buggy": {
      ...
      buttons: [
        { id: "heal", label: "💚 Хилл + время", cls: "primary" },
        { id: "god", label: "🛡️ Без аварий" },
        { id: "xb-turbo", label: "🚀 Турбо ×3" },
        { id: "xb-time", label: "⏱ +99 сек" },
        { id: "xb-finish", label: "🏁 Мгновенный финиш" },
        { id: "xb-fix", label: "✨ Починить багги" },
